...
![Pater Noster](./onze-vaderpvdv-full-score.png)
...
<span>Veni, Creátor</span> {#venicreator .init}
--------------------------
...
<span>Maagd Maria</span> {#maria .init}
========================
...
<span>De Engel des Heren</span> {#engel .init}
-------------------------------
...
<span>Gedenkgebed of Memorare</span> {#gedenk .init}
------------------------------------
...
Gedenk, o allermildste maagd Maria, dat het nog nooit gehoord is, dat
...
<span>Eer aan de Vader</span> {#eeraandevader .init}
-----------------------------
...
<span>Wees gegroet</span> {#weesgegroet .init}
-------------------------
...
<span>Rozenhoedje</span> {#rozenhoedje .init}
------------------------
...
<span>Stabat mater</span> {#stabatmater .init}
-------------------------
...
<span>Litanie van Loreto</span> {#litanievanloreto .init}
-------------------------------
...
<span>Voor de Mis</span> {#voor-de-mis .init}
========================
...
<span>Gebed tot Sint Jozef</span> {#gebedjozef .init}
---------------------------------
...
O félicem virum, beátum Joseph, cui datum est, Deum, quem multi reges
...
<span>Gebed van Sint Ambrosius</span> {#gebedambrosius .init}
-------------------------------------
...
Ad mensam dulcíssimi convívii tui, pie Dómine Jesu Christe, ego peccátor
...
Heer Jezus Christus, met eerbied en ontzag nader ik tot de tafel,
...
<span>Gebed van Thomas van Aquino</span> {#gebedaquinovoordemis .init}
----------------------------------------
...
Almachtige eeuwige God, ik mag naderen tot het sacrament van uw
...
<span>Na de Mis</span> {#na-de-mis .init}
======================
...
<span>Lofzang van Daniël</span> {#lofzangvandaniel .init}
-------------------------------
...
<span>Gebed tot de aartsengel Michaël</span> {#gebedtotdeaartsengelmichael .init}
--------------------------------------------
...
<span>Gebed van Thomas van Aquino</span> {#gebedaquinonademis .init}
----------------------------------------
...
Ik dank U, Heer, heilige Vader, almachtige eeuwige God, dat U mij,
...
<span>Orátio universális (Clemens XI)</span> {#universalis .init}
--------------------------------------------
...
<span>Absoute</span> {#absoute .init}
--------------------
...
[MAIL](mailto:info@gelovenleren.net)

</div>

<div id="blog">

[INFO](http://gelovenleren.net/blog/gebeden-app/)
...
[install ANDROID
APP](https://play.google.com/store/apps/details?id=net.gelovenleren.gebeden)
